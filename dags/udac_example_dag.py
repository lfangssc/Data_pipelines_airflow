...
# DAG dependencies
start_operator >>[create_staging_songs_table, create_staging_events_table, create_songplays_table, create_artists_table, create_songs_table, create_users_table, create_time_table]>>schema_created

schema_created>>[stage_events_to_redshift, stage_songs_to_redshift]>>load_songplays_table
